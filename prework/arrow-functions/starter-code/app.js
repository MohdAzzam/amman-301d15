...
// let jos = new Students('Kill',29,'Mofti');
// console.log(jos,'ccccccccccc');
// TODO: Uncomment the following line of code to see the output in the browser console
...
// console.log(joe.greetings(),'ssssss');
...
//  When using an arrow function "this" is not bound to anything and it just inherits it from the parent scope 
